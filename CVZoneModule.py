...
class HandDetector:
            ...
            for handType, handLms in zip(self.results.multi_handedness, self.results.multi_hand_landmarks):
                ...
                if draw:
                    ...
                    cv2.rectangle(img, (bbox[0] - 20, bbox[1] - 20),
                                  ...
                                  (0, 0, 0), 5)
                    text_size, _ = cv2.getTextSize(myHand["type"], cv2.FONT_HERSHEY_PLAIN, 2, 2)
                    cv2.rectangle(img, (bbox[0] - 20, bbox[1] - 20),
                                  (bbox[0] - 20 + text_size[0], bbox[1] - 10 + text_size[1]),
                                  (0, 0,0), cv2.FILLED)
                    cv2.putText(img, myHand["type"], (bbox[0] - 20, bbox[1] - 15 + text_size[1]), cv2.FONT_HERSHEY_PLAIN,
                                2, (255, 255, 255), 2)
    ...
    def findDistance(self, p1, p2, img=None, color=(255, 0, 255), scale=5, draw=False):
        ...
        if img is not None and draw:
            ...
            cv2.putText(img, str(int(length)), (cx, cy), cv2.FONT_HERSHEY_PLAIN, 2, (127,255,127), 2, cv2.LINE_AA)
...
def main():
    ...
    while True:
        ...
        if hands:
            ...
            cv2.putText(img, str(fingers1.count(1)), (10, 70), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 255), 3)  # Print the count of fingers that are up
